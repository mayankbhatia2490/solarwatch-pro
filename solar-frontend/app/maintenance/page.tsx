...
import { Wrench, Calendar, TrendingUp, AlertTriangle, Droplets, Loader2 } from "lucide-react";
...
export default function MaintenancePage() {
  ...
  // Log-cleaning inline form state
  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          <h1 className="text-3xl font-bold" style={{ color: "var(--card-value)" }}>Maintenance</h1>
          <p className="text-sm mt-1" style={{ color: "var(--text-secondary)" }}>
            Panel cleaning log · Predictive service alerts · Rain detection
          </p>
        </div>
        {data && (
          <div className="text-right">
            <div className="text-sm" style={{ color: "var(--text-secondary)" }}>Next Recommended Service</div>
